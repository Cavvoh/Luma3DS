...
void HomeButtonSimMenu_ChangeCombo(void)
{
    ...
    Draw_DrawString(10, 70, COLOR_YELLOW, "      not on HOME Menu.");
    ...
    do {
        ...
        Draw_DrawString(10, 60, COLOR_YELLOW, "Note: Only works inside applications,");
        Draw_DrawString(10, 70, COLOR_YELLOW, "      not on HOME Menu.");
        Draw_DrawString(10, 90, COLOR_GREEN, "Successfully changed the HOME button combo.");
        Draw_DrawString(10, 110, COLOR_GRAY, "Press B to go back.");
        Draw_FlushFramebuffer();
        Draw_Unlock();
